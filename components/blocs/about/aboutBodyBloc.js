        ...
        <div className={style.about_body__container}>
            ...
            <div className={style.about_body}>
                ...
                <div className={style.about_body__content}>
                    <div className={`${style.special_margin__bottom} ${style.about_body__item}`}>
                        <div className={style.about_item__image}>
                            <Image  lazyBoundary="500px" alt="Honnêteté" layout={"fill"} src="/pokouweb/honnete_illu_jqbh1h_hm5say.webp"/>
                        </div>
                        <h3>Honnêteté</h3>
                    ...
                    <div className={style.about_body__item}>
                        <div className={style.about_item__image}>
                            <Image  lazyBoundary="500px" alt="Curiosité" layout={"fill"} src="/pokouweb/curiosite_illu_qtrm4i_k8uutv.webp"/>
                        </div>
                        <h3>Curiosité</h3>
                    ...
                    <div className={style.about_body__item}>
                        <div className={style.about_item__image}>
                            <Image  lazyBoundary="500px" alt="La maîtrise" layout={"fill"} src="/pokouweb/maitrise2_illu_m2cgps_aybnwv.webp"/>
                        </div>
                        <h3>La maîtrise</h3>
                    ...
                    <div className={style.about_body__item}>
                        <div className={style.about_item__image}>
                            <Image  lazyBoundary="500px" alt="Sincère" layout={"fill"} src="/pokouweb/sincere_illu_ncmu0r_xzpvbp.webp"/>
                        </div>
                        <h3>Sincère</h3>
