            ...
            <SpeedFadeIn customClass="custom_about_header">
                <div className={style.siteweb_header}>
                    <div className={style.siteweb_header__left}>
                        ...
                        <p>Nous sommes développeurs, concepteurs et analystes. Nous sommes ouverts, curieux et affamés. Nous sommes des cyclistes, des joueurs et des boulangers. Et nous sommes tellement plus.</p>
                    </div>
