    ...
    return (
        ...
        <div className={ `${style.siteweb_header__container} ${style.project__onepalm__header}`}>
            <div className={style.header__background_image}>
                <Image layout={"fill"} objectFit={"cover"} priority={true} alt="One palm background" src="/pokouweb/onepalm_background_amhqkp_qur7aq.webp"/>
            </div>
            ...
            <SpeedFadeIn>
                <div className={style.siteweb_header}>
                    <div className={style.siteweb_header__left}>
                        ...
                        <p>OnePalm est une école de surf installée dans les Landes depuis une quinzaine d'années et un surf-shop. </p>
