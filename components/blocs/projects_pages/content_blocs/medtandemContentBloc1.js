                ...
                <div className={style.main__info}>
                    <div className={style.text_info__container}>
                        <div className={style.text__bloc}>
                            <h2>Une deuxième peau <br/> pour un site mature</h2>
                            <p>Medtandem disposait déjà d’une pemière mouture, fonctionnelle, mais pas parfaite. L’UX vieillissante méritait un bon coup de pinceau pour être au goût du jour. Il était également temps d’impléménter un nouveau système de paiement facilitant le parcours d’achat et la gestion des factures ainsi de que nouvelles fonctionnalités.</p>
<p>L'ajout de Stimulus.js nous a permis de dynamiser les intéractions afin d'éviter les rechargements de page qui pesait sur l'utilisation du site.</p>
                        </div>
                    </div>
