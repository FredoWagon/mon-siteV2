            ...
            <div className={style.ux_bloc}>
                <div className={style.ux_bloc__first_content}>
                    <div className={style.ux_bloc__left}>
                        <h2>L'utilisateur au centre</h2>
                        <p>Notre travail s'articule autour de la conception, de l'analyse, du développement, de l'optimisation et de la maintenance. L'idée principale qui traverse tout ce que nous faisons est de mettre l'utilisateur au centre : d'abord et avant tout, nous pensons toujours aux personnes qui finiront par utiliser ce que nous créons.</p>
                    </div>
